...
public class LiteHttpActivity extends Activity {
    protected String TAG = LiteHttpActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lite_http_layout);
        activity = this;
        initViews();
        initLiteHttp();
    }
    ...
    HttpListener<Bitmap> secondaryListener = new HttpListener<Bitmap>(true, true, true) {
        ...
        public void onStart(AbstractRequest<Bitmap> request) {
            ...
            progressDialog = new ProgressDialog(LiteHttpActivity.this);
